            ...
            <div class="col-4">
                ...
                <form action="koneksi.php" method="POST">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control mb-3" name="idPasien" id="idPasien" placeholder="ID Pasien">
                    </div>
                    <div class="form-group">
                        <label for="nmPasien">Nama Pasien</label>
                        <input type="text" class="form-control mb-3" name="nmPasien" id="nmPasien" placeholder="Nama Pasien">
                    </div>
                    <div class="form-group">
